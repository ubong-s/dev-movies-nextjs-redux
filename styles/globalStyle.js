...
const theme = {
   dark: {
      ...
      gradient2: `linear-gradient(to bottom, rgba(10, 9, 16, 0.99), rgba(10, 9, 16, 0.99) )`,
   ...
   light: {
      ...
      gradient2: `linear-gradient(to bottom, rgba(255,255,255, 0.99) ,rgba(255,255,255, 0.99) )`,
